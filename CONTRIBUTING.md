Contributing to FuerteCoinXtreme Core
============================

The FuerteCoinXtreme Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the FuerteCoinXtreme Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/fuertecoinxtreme-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to fuertecoinxtreme-qt
...
The following applies to code changes to the FuerteCoinXtreme Core project (and related
projects such as libsecp256k1), and is not to be confused with overall FuerteCoinXtreme
Network Protocol consensus changes.

Whether a pull request is merged into FuerteCoinXtreme Core rests with the project merge
...
Patches that change FuerteCoinXtreme consensus rules are considerably more involved than
...
Where a patch set proposes to change the FuerteCoinXtreme consensus, it must have been
...
The project leader is the release manager for each FuerteCoinXtreme Core release.
