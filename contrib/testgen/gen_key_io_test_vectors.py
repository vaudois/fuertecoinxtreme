...
bech32_templates = [
  ...
  ('fuecx',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('fuecx',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('fuecx',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('fuecx',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tfuecx',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfuecx',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfuecx',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfuecx',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tfuecx',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tfuecx',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tfuecx',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tfuecx',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rfuecx',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rfuecx',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rfuecx',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rfuecx', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tfuecx',   17, 32, Encoding.BECH32M, False, False, False),
  ('rfuecx',  3,  1, Encoding.BECH32M, False, False, False),
  ('fuecx',   15, 41, Encoding.BECH32M, False, False, False),
  ('tfuecx',    0, 16, Encoding.BECH32,  False, False, False),
  ('rfuecx',  0, 32, Encoding.BECH32,  True,  False, False),
  ('fuecx',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tfuecx',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rfuecx',  0, 20, Encoding.BECH32,  False, False, True),
  ('fuecx',    0, 20, Encoding.BECH32M, False, False, False),
  ('tfuecx',    0, 32, Encoding.BECH32M, False, False, False),
  ('rfuecx',  0, 20, Encoding.BECH32M, False, False, False),
  ('fuecx',    1, 32, Encoding.BECH32,  False, False, False),
  ('tfuecx',    2, 16, Encoding.BECH32,  False, False, False),
  ('rfuecx', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['fuecx', 'tfuecx', 'rfuecx']:
