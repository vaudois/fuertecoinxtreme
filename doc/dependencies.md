...
These are the dependencies currently used by FuerteCoinXtreme Core. You can find instructions for installing them in the `build-*.md` file for your platform.
