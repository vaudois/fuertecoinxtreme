# Support for Output Descriptors in FuerteCoinXtreme Core

Since FuerteCoinXtreme Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `fuecx1...` for mainnet or `tfuecx1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing FuerteCoinXtreme Core wallets, a convenience function `combo` is
