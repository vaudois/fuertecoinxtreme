...
{
    const char* pszTimestamp = "EU Times 03/June/2024 CoinXpool, This Visionary, Fuerte Coin Xtreme";
    const CScript genesisOutputScript = CScript() << ParseHex("040a631269e24db1b1e51d91f596ebb92ffe9e0df75d446c0cc06daf9d1e35931f405e71e2fc3a92c859510f6a26a766fadf7952781d1e8af2545aca280f591f8e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1717373187, 872008451, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000098a96c675d1bf2f6377d1fc8191aff40b05d4cd2f58eee52bf035b7f"));
        assert(genesis.hashMerkleRoot == uint256S("0xe104d06010e94da308fdf46cd8457127d1771b46dc1d5a43a7e4edbd82a8f74c"));
        ...
        vSeeds.emplace_back("seed1.fuertecoin.network");
        vSeeds.emplace_back("seed2.fuertecoin.network");
        vSeeds.emplace_back("seed3.fuertecoin.network");
        vSeeds.emplace_back("seed4.fuertecoin.network");
        vSeeds.emplace_back("seed5.fuertecoin.network");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("seedt1.fuertecoin.network");
        vSeeds.emplace_back("seedt2.fuertecoin.network");
        vSeeds.emplace_back("seedt3.fuertecoin.network");
