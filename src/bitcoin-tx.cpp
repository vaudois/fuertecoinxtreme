...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fuertecoinxtreme-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fuertecoinxtreme-tx [options] <hex-tx> [commands]  Update hex-encoded fuertecoinxtreme transaction\n" +
            "or:     fuertecoinxtreme-tx [options] -create [commands]   Create hex-encoded fuertecoinxtreme transaction\n" +
            "\n";
