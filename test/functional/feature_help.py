...
"""Verify that starting fuertecoinxtreme with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fuertecoinxtreme with -h for help text")
        ...
        self.log.info("Start fuertecoinxtreme with -version for version information")
        ...
        self.log.info("Start fuertecoinxtremed with -fakearg to make sure it does not start")
